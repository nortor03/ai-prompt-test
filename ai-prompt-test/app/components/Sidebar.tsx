...
export default function Sidebar() {
  ...
  const compareMenuItems = [
    ...
    { name: "Compare from History", path: "/compare/history" },
  ];
    ...
    <aside className="fixed top-0 left-0 w-72 h-screen bg-slate-50 text-slate-900 border-r border-slate-200 p-6 flex flex-col justify-between z-50">
      ...
      <div className="w-full">
        <div className="px-2 mb-10">
          <h1 className="font-bold text-slate-950 text-xl tracking-tight">UCR Analyzer</h1>
          <p className="text-xs text-slate-400 mt-1 font-mono">Urban Microclimate AI</p>
        </div>
